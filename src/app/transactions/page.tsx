        ...
        <div className="min-h-screen bg-gray-50 dark:bg-black text-foreground pb-20">
            ...
            <main className="max-w-md mx-auto p-4 space-y-6">
                <div className="flex items-center gap-2">
                    <Link href="/" className="p-2 -ml-2 rounded-full hover:bg-gray-200 dark:hover:bg-gray-800">
                        <ArrowLeft size={20} />
                    </Link>
                ...
                <div className="bg-white dark:bg-gray-900 rounded-xl p-4 shadow-sm border border-gray-100 dark:border-gray-800">
                    <h2 className="text-sm text-gray-500 font-medium mb-2">Filtered Summary</h2>
                    <div className="flex justify-between items-end">
                        <div>
                            <div className="text-2xl font-bold">{formatCurrency(netFlow)}</div>
                            <div className="text-xs text-gray-400">Net Flow</div>
                        </div>
                        <div className="text-right text-sm">
                            <div className="text-green-600 dark:text-green-400">+{formatCurrency(totalIncome)}</div>
                            <div className="text-red-600 dark:text-red-400">-{formatCurrency(totalExpense)}</div>
                        </div>
                    </div>
                </div>
